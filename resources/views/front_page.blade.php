...
<link rel="stylesheet" type="text/css" href=" {{ url('/css/back_ground_image.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/availability_card.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/room_cards.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/gallery.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/contact_form.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/footer_icons.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/services.css') }} " />
<link rel="stylesheet" type="text/css" href=" {{ url('/css/slide_show.css') }} " />
